...
class SecurePreferences(context: Context, prefsName: String) {
    ...
    private fun encrypt(plaintext: String): String {
        return try {
            ...
            Logx.e(TAG, "Encryption failed, storing plaintext fallback: ${e.message}")
            plaintext
        }
    }
    ...
    private fun decrypt(stored: String): String {
        ...
        return try {
            ...
            if (combined.size < GCM_IV_LENGTH + 16) return ""
            ...
            Logx.e(TAG, "Decryption failed: ${e.message}")
            ""
        }
    }
    ...
    fun getString(key: String, default: String?): String? {
        ...
        return decrypt(raw).ifEmpty { default }
    }
